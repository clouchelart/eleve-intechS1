...
var trait = function (req, res, query) {
	...
	grille = {
		"images" : [
			["/img/"+query.C00, "/img/"+query.C01, "/img/"+query.C02, "/img/"+query.C03, "/img/"+query.C04],
			["/img/"+query.C10, "/img/"+query.C11, "/img/"+query.C12, "/img/"+query.C13, "/img/"+query.C14],
		]
	};
	...
	page = fs.readFileSync('page_verifier_grille3.html', 'utf-8');

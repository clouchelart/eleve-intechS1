...
var trait = function (req, res, query) {
	...
	grille = {
		"images" : [
			["/img/"+query.C00, "/img/"+query.C01, "/img/"+query.C02],
			["/img/"+query.C10, "/img/"+query.C11, "/img/"+query.C12],
		]
	};
	contenu = JSON.stringify(grille);
	fs.writeFileSync("./Les_Grilles/grille_facile/grille_T1.json", contenu, "utf-8")

		console.log(contenu);

	page = fs.readFileSync('page_verifier_grille1.html', 'utf-8');
